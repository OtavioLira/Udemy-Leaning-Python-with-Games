...
class Laser(pygame.sprite.Sprite):
	...
	def meteor_collision(self):
		if pygame.sprite.spritecollide(self,meteor_group,True,pygame.sprite.collide_mask):
			...
			# pygame.sprite.spritecollide(self,laser_group,True)
...
class Meteor(pygame.sprite.Sprite):
	def __init__(self, pos, groups):
		...
		self.scaled_surf = pygame.transform.scale(meteor_surf,meteor_size)#200,500
	...
	def rotate(self):
		...
		self.rect = self.image.get_rect(center = self.rect.center) # update
		self.mask = pygame.mask.from_surface(self.image) # update
...
# Basic Setup
pygame.init()
WINDOW_HEIGHT, WINDOW_WIDTH = 500, 900
